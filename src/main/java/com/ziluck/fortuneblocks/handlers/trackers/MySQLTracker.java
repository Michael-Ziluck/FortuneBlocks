...
public class MySQLTracker extends BlockTracker {
    ...
    public boolean initialize() {
        String jdbcUrl = "jdbc:mysql://" + TRACKER_DATABASE_HOSTNAME + ":" + TRACKER_DATABASE_PORT + "/" + TRACKER_DATABASE_DATABASE;
        ...
        try {
            ...
            Properties properties = PropertiesBuilder.builder()
                    ...
                    .addProperty("DB_TYPE", "com.mysql.jdbc.Driver")
                    .toProperties();
